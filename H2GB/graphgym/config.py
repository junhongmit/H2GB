...
def assert_cfg(cfg):
    ...
    if cfg.dataset.task not in ['node', 'hetero_node', 'edge', 'hetero_edge', 'graph', 'link_pred']:
...
import H2GB.graphgym.contrib.config
