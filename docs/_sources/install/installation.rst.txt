...
:h2gb:`H²GB` is available for :python:`Python>=3.6`, and installation is easy!
...
Installing :h2gb:`H²GB` requires external library like :pytorch:`PyTorch` and :pyg:`PyG`. You can easily set up a conda environment to use :h2gb:`H²GB`. For example, in the following, we create a virtual environment named `H2GB`:
...
Now you are ready for installing :h2gb:`H²GB`!

Installation via PyPi
---------------------

To install :h2gb:`H²GB`, the easiest way is to simply run:
