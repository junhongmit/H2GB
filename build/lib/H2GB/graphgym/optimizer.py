...
from typing import Any, Iterator, Tuple, List, Optional, Union
...
from H2GB.graphgym.config import from_config
...
def create_optimizer(params: Iterator[Tuple[str, Parameter]], cfg: Any) -> Any:
    r"""Creates a config-driven optimizer."""
    params = list(params) 
    # Params is a generator, using next(iter(params)) will lose the first element
