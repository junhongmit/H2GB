...
# class RCDDDataset(InMemoryDataset):
...
#         val_mask = index_to_mask(test_idx, data['item'].num_nodes)
...
class RCDDDataset(InMemoryDataset):
    r"""
    Note: The original RCDD dataset from PyG has node numbering bugs. It's fixed
    according to my bug report: https://github.com/pyg-team/pytorch_geometric/issues/9212
