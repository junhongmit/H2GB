...
from h2gb_sphinx_theme.extension.logo import logo_role
# from h2gb_sphinx_theme.extension.slack import SlackButton
...
def monkey_patch_find_autosummary_in_lines(
    ...
    for line in lines:
        if in_autosummary:
            ...
            # Begin of modified part by `h2gb_sphinx_theme` #####################
            ...
            if m:
                ...
                continue
            # End of modified part by `h2gb_sphinx_theme` ######################
...
def setup(app):
    ...
    app.add_role('h2gb', logo_role)
    app.add_role('unifiedgt', logo_role)
    app.add_role('graphgym', logo_role)
